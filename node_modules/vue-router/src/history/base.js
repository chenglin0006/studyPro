...
export class History {
  ...
  //会执行vue-router一系列的钩子函数
  transitionTo (location: RawLocation, onComplete?: Function, onAbort?: Function) {
    //调用match函数来得到匹配的route对象
    ...
    this.confirmTransition(route, () => {
      ...
      //根据mode配置来更新url地址（mode：hash＝》更新hash值；mode＝》history＝》利用pushstate/replacestate来更新）
      this.ensureURL()
  ...
  confirmTransition (route: Route, onComplete: Function, onAbort?: Function) {
    ...
    //比较当前路由的路由记录和目标路由的路由记录以便能准确得到父子路由更新的情况下哪些组件需要更新，哪些组件不需要更新
    const {
      updated,
      deactivated,
      activated
