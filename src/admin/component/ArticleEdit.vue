	...
	<div class="articel-edit-wrap">
        ...
        <div class="article-toolbar">
            <div class="label">
                ...
                <el-tag style="margin: 0 3px 0 3px;" v-for="item in list" :closable="true" type="success" :close-transition="false" @close="handleClose(item)">
                    {{item.tagName}}
                </el-tag>
            </div>
