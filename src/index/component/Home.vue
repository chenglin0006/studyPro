    ...
    mounted: function(){
        ...
        if(this.$route.query.tagId){
            this.$http.post('/api/articleList', {
                ...
                respone => this.$store.dispatch('getArticleList',respone.body.reverse()),
    ...
    methods: {
    	...
    	fetchData: function(){
    	    this.$http.get('/api/articleList').then(
                respone => {
                    this.$store.dispatch('getArticleList',respone.body.reverse());
                },
                respone => console.log('error'+respone)
            )
    	}
    },
    computed:mapGetters({
